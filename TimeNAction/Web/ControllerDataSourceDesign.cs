...
namespace TimeNAction.Web.Design
{
    ...
    public class ControllerDataSourceDesignView : DesignerDataSourceView
    {
        ...
        public override IDataSourceViewSchema Schema
        {
            get
            {
                ...
                Stream res = GetType().Assembly.GetManifestResourceStream(String.Format("TimeNAction.Controllers.{0}.xml", DataController));
                if (res == null)
                	res = GetType().Assembly.GetManifestResourceStream(String.Format("TimeNAction.{0}.xml", DataController));
                if (res != null)
